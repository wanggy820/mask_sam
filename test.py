...
# MedSAM_CKPT_PATH = "models_no_box/ISIC2016_sam_best.pth"
...
def medsam_inference(medsam_model, img_embed, box_1024, height, width):
    ...
    for i in range(int(box_1024[0][0]/4), int(box_1024[0][2]/4)):
        for j in range(int(box_1024[0][1]/4), int(box_1024[0][3]/4)):
            mask[0][0][j][i] = 255
